  ...
  input_df %>% 
    ...
    mutate(region = case_when(settlement %in% c("Kyaka Ii", "Kyangwali", "Nakivale", "Oruchinga", "Rwamwanja") ~ "South West",
       ...
       # health indicators
           ...
           i.chronic_illness_age_group_0_2 = ifelse(i.chronic_illness_age_group %in% c("age_0_2"), 
                                                i.hh_member_with_chronic_condition, NA_character_), 
           i.chronic_illness_age_group_3_5 = ifelse(i.chronic_illness_age_group %in% c("age_3_5"), 
                                                 i.hh_member_with_chronic_condition, NA_character_), 
           i.chronic_illness_age_group_6_12 = ifelse(i.chronic_illness_age_group %in% c("age_6_12"), 
                                                 i.hh_member_with_chronic_condition, NA_character_), 
           i.chronic_illness_age_group_13_18 = ifelse(i.chronic_illness_age_group %in% c("age_13_18"), 
                                                 i.hh_member_with_chronic_condition, NA_character_), 
           i.chronic_illness_age_group_19_24 = ifelse(i.chronic_illness_age_group %in% c("age_19_24"), 
                                                i.hh_member_with_chronic_condition, NA_character_),
           i.chronic_illness_age_group_25_59 = ifelse(i.chronic_illness_age_group %in% c("age_25_59"), 
                                                      i.hh_member_with_chronic_condition, NA_character_), 
           i.chronic_illness_age_group_above_59 = ifelse(i.chronic_illness_age_group %in% c("age_greater_59"), 
                                                     i.hh_member_with_chronic_condition, NA_character_),
      ...
      # livelihoods indicators
            i.hh_member_occupation_age_group = case_when((progres_age >=0 & progres_age <3) ~ "age_0_2",
                                                         (progres_age >2 & progres_age <6) ~ "age_3_5",
                                                         (progres_age >5 & progres_age <13) ~ "age_6_12",
                                                         (progres_age >12 & progres_age <19) ~ "age_13_18",
                                                         (progres_age >18 & progres_age <25) ~ "age_19_24",
                                                         (progres_age >24 & progres_age <60) ~ "age_25_59",
                                                         (progres_age > 59)  ~ "age_greater_59",
                                                         TRUE ~ NA_character_),
    
           i.hh_member_occupation_age_group_0_2 = ifelse(i.hh_member_occupation_age_group %in% c("age_0_2"), 
                                                          main_occupation_past_year, NA_character_),
           i.hh_member_occupation_age_group_3_5 = ifelse(i.hh_member_occupation_age_group %in% c("age_3_5"), 
                                                          main_occupation_past_year, NA_character_),
           i.hh_member_occupation_age_group_6_12 = ifelse(i.hh_member_occupation_age_group %in% c("age_6_12"),
                                                          main_occupation_past_year, NA_character_),
           i.hh_member_occupation_age_group_13_18 = ifelse(i.hh_member_occupation_age_group %in% c("age_13_18"), 
                                                          main_occupation_past_year, NA_character_),
           i.hh_member_occupation_age_group_19_24 = ifelse(i.hh_member_occupation_age_group %in% c("age_19_24"), 
                                                          main_occupation_past_year, NA_character_),
           i.hh_member_occupation_age_group_25_59 = ifelse(i.hh_member_occupation_age_group %in% c("age_25_59"), 
                                                          main_occupation_past_year, NA_character_),
           i.hh_member_occupation_age_group_above_59 = ifelse(i.hh_member_occupation_age_group %in% c("age_greater_59"), 
                                                          main_occupation_past_year, NA_character_),
  
           i.hh_member_worked_past7days_age_group = case_when((progres_age >=0 & progres_age <3) ~ "age_0_2",
                                                                (progres_age >2 & progres_age <6) ~ "age_3_5",
                                                                (progres_age >5 & progres_age <13) ~ "age_6_12",
                                                                (progres_age >12 & progres_age <19) ~ "age_13_18",
                                                                (progres_age >18 & progres_age <25) ~ "age_19_24",
           ...
           i.worked_in_past_7_days = case_when(worked_in_past_7_days == 1725 ~ "Worked at least one hour for pay or profit",
                                                 worked_in_past_7_days == 1726 ~ "Did not work, but was actively searching for work",
                                                 worked_in_past_7_days == 1727 ~ "Did not work, and was not actively searching for work"),
           
      i.hh_member_worked_past7days_age_group_0_2 = ifelse(i.hh_member_worked_past7days_age_group %in% c("age_0_2"), 
                                                    i.worked_in_past_7_days, NA_character_),
      i.hh_member_worked_past7days_age_group_3_5 = ifelse(i.hh_member_worked_past7days_age_group %in% c("age_3_5"), 
                                                    i.worked_in_past_7_days, NA_character_),
      i.hh_member_worked_past7days_age_group_6_12 = ifelse(i.hh_member_worked_past7days_age_group %in% c("age_6_12"),
                                                     i.worked_in_past_7_days, NA_character_),
      i.hh_member_worked_past7days_age_group_13_18 = ifelse(i.hh_member_worked_past7days_age_group %in% c("age_13_18"), 
                                                      i.worked_in_past_7_days, NA_character_),
      i.hh_member_worked_past7days_age_group_19_24 = ifelse(i.hh_member_worked_past7days_age_group %in% c("age_19_24"), 
                                                      i.worked_in_past_7_days, NA_character_),
      i.hh_member_worked_past7days_age_group_25_59 = ifelse(i.hh_member_worked_past7days_age_group %in% c("age_25_59"), 
                                                      i.worked_in_past_7_days, NA_character_),
      i.hh_member_worked_past7days_age_group_above_59 = ifelse(i.hh_member_worked_past7days_age_group %in% c("age_greater_59"), 
                                                      i.worked_in_past_7_days, NA_character_),
...
create_composites_sampled <- function(input_df) {
  input_df %>%
    mutate(region = case_when(settlement %in% c("Kyaka Ii", "Kyangwali", "Nakivale", "Oruchinga", "Rwamwanja") ~ "South West",
      ...
      # wash
          ...
          i.number_of_minutes_to_and_from_water_source = case_when(number_of_minutes_to_and_from_water_source < 30 ~ "less_than_30_min",
                                                             (number_of_minutes_to_and_from_water_source > 29 & 
                                                              number_of_minutes_to_and_from_water_source < 61) ~ "between_30_and_60_min",
    ...
    # shelter and nfi
          ...
          # i.number_water_container = case_when(i.hh_size_jerrycan_category %in% c("between_1_and_3_HH_size", "between_4_and_6_HH_size", "between_7_and_9_HH_size",
          #                                                                     "10_or_more_HH_size") ~ jerry_can_num),
          # i.number_water_container = as.numeric(i.number_water_container),
          # i.national_median_water_container = median(i.number_water_container, na.rm = TRUE),
          # 
          # 
          # i.hh_size_bucket_category = case_when((hh_size > 0 & hh_size <4)& plastic_bucket_cond %in%c("good", "moderate") ~ "between_1_and_3_HH_size",
          ...
          # i.number_plastic_bucket = ifelse(i.hh_size_bucket_category %in% c("between_1_and_3_HH_size", "between_4_and_6_HH_size", "between_7_and_9_HH_size",
    ...
    # 
    # i.hh_size_tarpaulin_category = case_when((hh_size > 0 & hh_size <4)& tarpaulin_cond %in%c("good", "moderate") ~ "between_1_and_3_HH_size",
    ...
    # i.number_tarpaulin = ifelse(i.hh_size_tarpaulin_category %in% c("between_1_and_3_HH_size", "between_4_and_6_HH_size", "between_7_and_9_HH_size",
    ...
    # 
    # i.hh_size_solar_lamp_category = case_when((hh_size > 0 & hh_size <4)& solar_lamp_cond %in%c("good", "moderate") ~ "between_1_and_3_HH_size",
    ...
    # i.number_solar_lamp = ifelse(i.hh_size_solar_lamp_category %in% c("between_1_and_3_HH_size", "between_4_and_6_HH_size", "between_7_and_9_HH_size",
    ...
    # 
    # i.hh_size_kitchen_set_category = case_when((hh_size > 0 & hh_size <4)& (kitchen_set_cond %in%c("good", "moderate")) ~ "between_1_and_3_HH_size",
    ...
    # i.number_kitchen_set = ifelse(i.hh_size_kitchen_set_category %in% c("between_1_and_3_HH_size", "between_4_and_6_HH_size", "between_7_and_9_HH_size",
