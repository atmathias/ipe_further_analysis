...
create_composites_verification <- function(input_df) {
  input_df %>% 
    ...
    mutate(region = case_when(settlement %in% c("Kyaka Ii", "Kyangwali", "Nakivale", "Oruchinga", "Rwamwanja") ~ "South West",
                ...
                i.hh_member_with_chronic_condition = ifelse(!is.na(hh_member_with_chronic_condition),
                                                       hh_member_with_chronic_condition, NA_character_),
                ...
                i.hh_member_with_chronic_condition_by_age_group = case_when(hh_member_with_chronic_condition == 1694 ~ "yes", 
                                                                              ...
                                                                              TRUE ~  NA_character_),
                i.hh_member_with_chronic_condition_access_healthcare  = ifelse(!is.na(hh_member_with_chronic_condition_access_healthcare),
                                                                          hh_member_with_chronic_condition_access_healthcare, NA_character_),
             ...
             i.hh_member_occupation_pastyear = ifelse(!is.na(36), main_occupation_past_year,
                                                      NA_character_),
             i.hh_member_occupation_pastyear_by_age_group = i.hh_member_occupation_pastyear,
             i.hh_member_occupation_age_group_by_gender = ifelse(!is.na(36), i.hh_member_occupation_age_group,
                                                       NA_character_),
             i.hh_member_worked_past7days_age_group = case_when((progres_age >= 0 & progres_age <= 2) ~ "age_0_2",
                                                              ...
                                                              (progres_age > 59)  ~ "age_greater_59",
                                                              TRUE ~ NA_character_),
              i.hh_member_worked_past7days = ifelse(!is.na(hh_member_worked_past7days), hh_member_worked_past7days,
                                                    NA_character_),
              i.hh_member_worked_past7days_by_age_group = i.hh_member_worked_past7days,
              i.hh_member_worked_past7days_age_grp_by_gender = ifelse(!is.na(hh_member_worked_past7days), i.hh_member_worked_past7days_age_group,
                                                              NA_character_),
  ...
  i.children_attending_school = ifelse(!is.na(children_attending_school), children_attending_school,
                                       NA_character_),
  ...
  i.children_attending_school_by_age_group = i.children_attending_school,
  i.school_going_age_group_by_gender = ifelse(!is.na(children_attending_school), i.school_going_age_group,
                                                 NA_character_)) %>% 
...
# mental health 
   ...
   create_composites_mental_health <- function(input_df) {
     ...
     mutate(i.mental_health_age_category = case_when(
         ...
         i.hh_member_mh_by_age_group = i.hh_member_mh_state,
         i.hh_member_mh_by_age_grp_gender = ifelse(!is.na(i.hh_member_mh_state), i.mental_health_age_category,
                                                   NA_character_)
     ) %>% 
